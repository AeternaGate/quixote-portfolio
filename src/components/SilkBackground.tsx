...
/**
 * Silk WebGL background from ReactBits (adapted), tuned to the crimson palette.
 * Sits far behind the rose video as a subtle depth layer.
 */
...
export default function SilkBackground() {
  ...
  const uniforms = useMemo<SilkUniforms>(
    () => ({
      ...
      uColor: { value: new Color(...hexToNormalizedRGB('#3a0f12')) },
      uRotation: { value: 0.35 },
      uTime: { value: 0 },
    }),
    []
  );
